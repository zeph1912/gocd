...
public class CachedGoConfig {
    ...
    private synchronized void saveConfigError(Exception e) {
        ...
        ServerHealthState state = ServerHealthState.error(GoConfigService.INVALID_CRUISE_CONFIG_XML, GoConfigValidity.invalid(e).errorMessage(), HealthStateType.invalidConfig());
